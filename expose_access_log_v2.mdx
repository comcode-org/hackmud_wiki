---
title: expose_access_log_v2
---

> sys.expose_access_log allows you to view the access log of a compromised system.

expose_access_log_v2 is a tier 2 upgrade. It spawns at ((%1kiddie%)), ((%2h4x0r%)) and ((%3h4rdc0r3%)) rarities.

## Stats

### cooldown

The 'cooldown' stat, which is displayed in seconds, determines how much time must pass after use before the expose_access_log_v2 can be executed again.

### count

The 'count' stat displays the number of access logs can be exposed by the expose_access_log_v2 being used.
