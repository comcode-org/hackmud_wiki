  ...
  directivesSidebar: [
    {
      ...
      link: {
        ...
        description:
          "hackmud scripts have access to a variety of hackmud-specific preprocessor directives, which are converted to usable functions during script runtime. This is an auto-generated list of documented preprocessor directives. This category also covers special variables initialised at the start of a script run.",
        slug: "scripting/directives",
      },
      items: [{ type: "autogenerated", dirName: "scripting/directives" }],
    },
  ],
  syntaxSidebar: [
    {
