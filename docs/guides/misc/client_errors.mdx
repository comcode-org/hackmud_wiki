...
Make sure Steam & your OS are up-to-date (might need a retart) and that you have a stable connection to Steam
...
If there is no client output after launching the game, this is typically indicative of a man-in-the-middle (such as a censorious ISP) blocking the connection to hackmud.
