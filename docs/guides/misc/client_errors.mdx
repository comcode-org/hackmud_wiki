...
New hackmud accounts may only make purchases via ((%Cstore_list%)) after a waiting period.

### STORE ERROR: unknown

'unknown' store errors are errors which are hidden from the client for security reasons.

Often, this error is indicative of an _untrusted_ Steam account. Please open a [support ticket in our discord](https://discord.com/channels/229545531104296960/364244133130272768) server to resolve this issue.
