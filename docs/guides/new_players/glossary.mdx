...
A list of terminology, [jargon](#jargon-file) and slang important to _hackmud_.
...
### binmat
A card game in _hackmud_ discovered through the `mallory_saves_fighting` event. See [[binmat]] for more detailed information.
...
The act of making a script shorter. Useful in _hackmud_ because of [[char_count:limits on character count]].
