...
:::note
The in-game [[chats.send:((chats.send))]] / [[chats.tell:((chats.tell))]] message limitations (max. 1000 character or 10 lines, 5 messages per 20 seconds per user) apply to messages sent from the chat API as well, and are shared.
:::
