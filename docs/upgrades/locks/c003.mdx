...
The (( %Nc003_triad_1% )) and (( %Nc003_triad_2% )) arguments are the [color triads](https://en.wikipedia.org/wiki/Color_scheme#Triadic) for the color you are attempting. (( %Nc003_triad_1% )) and (( %Nc003_triad_2% )) are strings.
