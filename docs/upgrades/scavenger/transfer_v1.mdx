...
Once transfer_v1 has been loaded, ((%5sys%)).((%2xfer_gc_from%)) can be used to target a breached system for a fee of 1((%2M%))500((%NK%))((%0GC%)) or 2.5% of the amount being taken, whichever is higher.
