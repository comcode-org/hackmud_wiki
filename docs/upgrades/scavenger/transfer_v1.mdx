...
Once transfer_v1 has been loaded, ((%5sys%)).((%2xfer_gc_from%)) can be used to target a breached system for a fee of ((%11%))((%2M%))((%1500%))((%NK%))((%0GC%)) or ((%12.5%))((%1%%)) of the amount being taken, whichever is higher.
...
((%5sys%)).((%2xfer_gc_from%)) can be executed using the following syntax:
