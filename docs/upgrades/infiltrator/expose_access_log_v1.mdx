...
expose_access_log_v1 is a tier 1 upgrade. Spawns at 'noob', 'kiddie', and 'h4x0r' rarities.
...
expose_access_log_v1 can be run against a breached system for a cost of 50KGC. The amount of [[GC]] required is displayed upon execution attempt. If the expose_access_log_v1 is on cooldown, an error containing the remaining cooldown time will be displayed upon execution attempt. For syntax information see [[sys.expose_access_log]].
