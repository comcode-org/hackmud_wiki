...
Takes a string from a list of possible avatars.

#### user_age

Takes a boolean and toggles displaying user age in the YYMMDD.HHMM format.

#### account_age

Takes a boolean and toggles displaying account age in the YYMMDD.HHMM format.
...
Takes a string from a list of possible titles.
